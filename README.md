...
Little endian base 128 implementation, which stores arbitrarily large unsigned integers in a variable length format.
...
```
cd existing_repo
git remote add origin https://gitlab.com/bolderflight/software/leb128.git
git branch -M main
